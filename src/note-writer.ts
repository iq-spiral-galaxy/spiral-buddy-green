...
/**
 * 판단 규칙 섹션 본문을 개별 규칙으로 분해.
 * 최상위 불릿(-, *, 1.)을 항목 경계로 사용 — 들여쓴 sub-불릿은 부모에 포함.
 * 불릿이 없으면 본문 전체를 규칙 1개로 취급.
 */
export function splitRuleItems(sectionBody: string): string[] {
